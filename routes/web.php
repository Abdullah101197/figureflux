...
Route::prefix('admin')->middleware(['auth', 'xss', 'role:admin'])->group(function () {
    ...
    Route::get('/social-media', [SettingController::class, 'mediaSettings'])->name('settings.social-media');
    Route::post('/store-social-media', [SettingController::class, 'store_mediaSettings'])->name('store.social_media');
    Route::delete('delete/{id}', [SettingController::class, 'destroy'])->name('media.destroy');
...
Route::prefix('client')->middleware(['auth', 'xss', 'role:client'])->group(function () {
    ...
    Route::get('packages', [Client\DashboardController::class,'clientPackages'])->name('client.packages.index');
