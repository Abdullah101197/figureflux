...
<table width="100%">
    <tr>
        <td colspan="2">
            ...
            {{$styleCss}}="border-bottom: 10px solid {{ $invoice_template_color }};">INVOICE
            </div>
            <div class="logo"><img width="250px" src="{{ getLogoUrl() }}" alt=""></div>
        </td>
    </tr>
</table>
<br>
<table width="100%">
    ...
    <tr>
        <td class="vertical-align-top">
            ...
            <b>Mo:&nbsp;</b>{{ $setting['company_phone'] }}<br>
            ...
            <table class="invoice-footer">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    {{$check = getInvoiceDueAmount($invoice->id)}}

                   @if($check == 0)
                    <span class="stamp is-paid">PAID</span>
                    @else
                    <span class="stamp is-unpaid">UNPAID</span>
                    @endif
                </tr>
            </table>
        </td>
