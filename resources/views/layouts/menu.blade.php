...
<li class="nav-item {{ Request::is('admin/taxes*') ? 'active' : '' }}">
 ...
 <li class="nav-item {{ Request::is('admin/jobs*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('jobs.index') }}">
       <span class="menu-icon">
          <i class="fa-solid fas fa-cube pe-3"></i>
        </span>
        <span class="aside-menu-title">{{ __('My Jobs') }}</span>
    </a>
</li>
<li class="nav-item {{ Request::is('admin/packages*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('packages.index') }}">
       <span class="menu-icon">
          <i class="fa-solid fas fa-cube pe-3"></i>
        </span>
