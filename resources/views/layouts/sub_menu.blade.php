...
@else
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('admin/settings*', 'admin/currencies*', 'admin/payment-gateway*','admin/social-media*','admin/invoice-settings')) ? 'd-none' : '' }}">
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('admin/settings*', 'admin/currencies*', 'admin/payment-gateway*' ,'admin/social-media*','admin/invoice-settings')) ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('admin/social-media*') ? 'active' : '' }}"
           href="{{ route('settings.social-media') }}">{{__('messages.setting.social_media')}}</a>
    </li>
