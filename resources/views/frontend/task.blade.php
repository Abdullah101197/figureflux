                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="banner-content">
                                <h2>Be More Productive With Figureflux Tasks Feature</h2>
                                <p>A powerful task management system makes it easy to plan, organize, and collaborate on any
                                    project.</p>
            ...
            <div class="custom-container">
                <div class="inner-process">
                    <div class="plan-title">
                        <span>FEATURES</span>
                        <h3>Customized Workflow Solutions</h3>
                    </div>
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="process-content">
                                <span>ORGANIZE</span>
                                <h2>Step-By-Step Approach To Large Projects</h2>
                                <p>Achieve the best feasible level of productivity by focusing on more manageable, smaller subtasks.
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="process-image">
                                <div class="process-img">
                                    <img src="assets/images/orginze.png" alt="ORGANIZE">
                                </div>
                            </div>
                        </div>
                    </div>
