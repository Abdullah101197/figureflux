        ...
        <div class="feature-wrapper">
            ...
            <div class="feature-inner">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-productservice-tab" data-bs-toggle="pill" data-bs-target="#pills-productservice" type="button" role="tab" aria-controls="pills-productservice" aria-selected="false">product & service</button>
                    </li>
                    <li class="nav-item" role="presentation">
                      <button class="nav-link active" id="pills-ordermanagement-tab" data-bs-toggle="pill" data-bs-target="#pills-ordermanagement" type="button" role="tab" aria-controls="pills-ordermanagement" aria-selected="false">order management</button>
                    </li>
                    <li class="nav-item" role="presentation">
                  ...
                  <div class="tab-content feature-details" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-productservice" role="tabpanel" aria-labelledby="pills-productservice-tab">
                        <div class="custom-container">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="process-content">
                    ...
                    <div class="tab-pane fade show active" id="pills-ordermanagement" role="tabpanel" aria-labelledby="pills-ordermanagement-tab">
                        <div class="custom-container">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="process-content">
