...
<div class="custom-container">
    <div class="main-tainging">
        <h3>Welcome to FigureFlux.com!</h3>
        <p>These terms and conditions outline the rules and regulations for the use of FigureFlux's Website, located
            at https://FigureFlux.com/.
            By accessing this website we assume you accept these terms and conditions. Do not continue to use
            FigureFlux.com if you do not agree to take all of the terms and conditions stated on this page.
        ...
        <h2>Cookies</h2>
        <p>We employ the use of cookies. By accessing FigureFlux.com, you agreed to use cookies in agreement with
            the FigureFlux's Privacy Policy.
        ...
        <h2>License</h2>
        <p>Unless otherwise stated, FigureFlux and/or its licensors own the intellectual property rights for all
            material on FigureFlux.com. All intellectual property rights are reserved. You may access this from
            FigureFlux.com for your own personal use subject to restrictions set in these terms and conditions.
            <br>You must not:
        </p>
        <ul>
            <li>Republish material from FigureFlux.com</li>
            <li>Sell, rent or sub-license material from FigureFlux.com</li>
            <li>Reproduce, duplicate or copy material from FigureFlux.com</li>
            <li>Redistribute content from FigureFlux.com</li>
        </ul>
        <p>
            ...
            certain areas of the website. FigureFlux does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and opinions of FigureFlux,its agents
            and/or affiliates. Comments reflect the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, FigureFlux shall not be liable for the Comments or
            for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting
            of and/or appearance of the Comments on this website.<br>
            FigureFlux reserves the right to monitor all Comments and to remove any Comments which can be considered
            inappropriate, offensive or causes breach of these Terms and Conditions.<br>
        ...
        <p>
            You hereby grant FigureFlux a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            absence of FigureFlux; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an email to FigureFlux. Please include your name, your
        ...
        <p>
            No use of FigureFlux's logo or other artwork will be allowed for linking absent a trademark license
            agreement.<br>
            iFrames<br>
        ...
        <h2>Disclaimer</h2>
        <span> To the maximum extent permitted by applicable law, we exclude all representations, warranties and
            conditions relating to our website and the use of this website. Nothing in this disclaimer will:</span>
        <ul>
