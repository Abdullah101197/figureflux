...
Data protection
@endsection
@section('content')<div class="custom-container">
    <div class="main-tainging">
        <h1>Data Privacy Policy for FigureFlux</h1>
        <p>At FigureFlux.com, accessible from https://FigureFlux.com/, one of our main priorities is the privacy of
            our visitors. This Privacy Policy document contains types of information that is collected and recorded
            by FigureFlux.com and how we use it.
            If you have additional questions or require more information about our Privacy Policy, do not hesitate
            to contact us. Our Privacy Policy was generated with the help of GDPR Privacy Policy Generator
        </p>
        <h2>General Data Protection Regulation (GDPR)</h2>
        <span>
            We are a Data Controller of your information.<br>
            FigureFlux legal basis for collecting and using the personal information described in this Privacy
        ...
        <span>FigureFlux legal basis for collecting and using the personal information described in this Privacy
            Policy depends on the Personal Information we collect and the specific context in which we collect the
            information:</span>
        <ul>
            <li>FigureFlux needs to perform a contract with you</li>
            <li>You have given FigureFlux permission to do so</li>
            <li>Processing your personal information is in FigureFlux legitimate interests</li>
            <li>FigureFlux needs to comply with the law</li>
        </ul>
        <p>FigureFlux will retain your personal information only for as long as is necessary for the purposes set
        ...
        <h2>Log Files</h2>
        <p>FigureFlux.com follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <p>Like any other website, FigureFlux.com uses 'cookies'. These cookies are used to store information
        ...
        <p>Google is one of the third-party vendors on our site. It also uses cookies, known as DART cookies, to
            ...
            content network Privacy Policy at the following URL – https://policies.google.com/technologies/ads</p>
        ...
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of
            ...
            used in their respective advertisements and links that appear on FigureFlux.com, which are sent directly
            to users' browsers. They automatically receive your IP address when this occurs. These technologies are
        ...
        <p>Note that FigureFlux.com has no access to or control over these cookies that are used by third-party
            advertisers.</p>
        <h2>Third Party Privacy Policies</h2>
        <p>FigureFlux.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
        ...
        <p>Another part of our priority is adding protection for children while using the internet. We encourage
            ...
            FigureFlux.com does not knowingly collect any Personal Identifiable Information from children under the
        ...
        <p>Our Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collected in FigureFlux.com. This policy is not
