                ...
                <div class="card">
                    <form id="userProfileEditForm" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-6">
                                <label class="col-lg-4 form-label">{{ __('messages.user.business_name').':' }}</label>
                                <div class="col-lg-8">
                                    <div class="row">
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            {!! Form::text('first_name', $user->business_name, ['class'=> 'form-control', 'placeholder' => 'First name', 'required', 'id' => 'editProfileFirstName']) !!}
