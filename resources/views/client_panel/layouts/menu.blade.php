...
<li class="nav-item {{ Request::is('client/packages*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('client.packages.index') }}">
            <span class="menu-icon">
               <i class="far fa-file-alt pe-3"></i>
            </span>
        <span class="aside-menu-title">{{__('My Packages')}}</span>
    </a>
</li>
