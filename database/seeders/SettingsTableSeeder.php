...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Setting::create(['key' => 'app_name', 'value' => 'FigureFlux']);
        Setting::create(['key' => 'app_logo', 'value' => $imageUrl]);
        Setting::create(['key' => 'company_name', 'value' => 'FigureFlux']);
        ...
        Setting::create(['key' => 'time_zone', 'value' => 'Asia/Karachi']);
        Setting::create(['key' => 'current_currency', 'value' => '4']);
