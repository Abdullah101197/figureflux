...
class SettingController extends AppBaseController
{
    ...
    public function mediaSettings()
    {
       ...
       $socialMedia = social_media_setting::all();

        return view('settings.social_media',compact('socialMedia'));

    }
    public function store_mediaSettings(Request $request)
    {
        ...
        social_media_setting::create($input);

        return redirect()->route('settings.social-media')
    ...
    public function destroy(Request $request,$id)
    {
        ...
        $media = social_media_setting::find($id);
        $media->delete();
