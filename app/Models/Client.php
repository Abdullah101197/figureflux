...
class Client extends Model
{
    ...
    {
        return $this->hasMany(subcription::class, 'client_id', 'id');
    }


    /**
     * The packages that belong to the Client
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany
     */
    public function packages(): BelongsToMany
    {
        return $this->belongsToMany(Package::class, 'subcriptions', 'client_id', 'package_id');
    }
