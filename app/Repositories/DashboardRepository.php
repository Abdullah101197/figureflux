...
class DashboardRepository
{
    ...
    public function getClientDashboardDataSubcription()
    {
        ...
        if ($package_id != null) {
            ...
            $user = getLogInUser();
            $packages = Package::where('id', $package_id)->get()->toArray();
            $clientPackage['packages'] = $packages;
            $clientPackage['client'] = $user->client->id;
            $clientPackage['session'] = $package_id;
            ...
            $clientPackage['packages'] = $packages;
            $clientPackage['client'] =  auth()->user()->client->id;
            return $clientPackage;
    ...
    public function getClientSubcriptionStatus()
    {


        $user = getLogInUser();
        $client_id = auth()->user()->client->id;
        $subcription = subcription::where("client_id", $client_id)->get()->toArray();
        return $subcription;
